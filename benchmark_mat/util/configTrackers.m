...
trackersDeep={
    ...
    struct('name','CNT','namePaper','CNT'),...
    struct('name','DLT','namePaper','DLT'),...
    struct('name','Kalman','namePaper','Kalman'),...
    struct('name','NCC','namePaper','NCC')};

trackersBound={
%     struct('name','BoundNet','namePaper','BoundNet')
    struct('name','NCCCNN','namePaper','NCCCNN')
    };

%     struct('name','CNNSVM','namePaper','CNNSVM'),...
